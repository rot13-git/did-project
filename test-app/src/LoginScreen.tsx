        ...
        <form style='margin-top: 20px;' onSubmit={ this.onFormSubmitted }>
          <fieldset disabled={ submitting }>
            ...
            <div class='form-group'>
              ...
              <input type='text' class='form-control' value={ hubOptions.clientDid } onChange={ linkState.linkState(this, 'hubOptions.clientDid') }
                placeholder='did:example:me.id'/>
            </div>

            <div class='form-group'>
              <label>Your JWK private key <span class='text-muted'>(it's ok, trust us)</span></label>
              <textarea class='form-control' value={ hubOptions.clientPrivateJwk } onChange={ linkState.linkState(this, 'hubOptions.clientPrivateJwk') }
                rows={4} placeholder='{ &quot;kty&quot;:&quot;RSA&quot;, &quot;kid&quot;:&quot;key-1&quot;, ... }'></textarea>
            </div>

            <div class='form-group'>
              <label>DID Resolver Endpoint</label>
              <input type='text' class='form-control' value={ hubOptions.didResolver } onChange={ linkState.linkState(this, 'hubOptions.didResolver') }
            ...
            { showAdvanced &&
              <div class='form-group'>
                <label>Hub DID</label>
                <input type='text' class='form-control' value={ hubOptions.hubDid } onChange={ linkState.linkState(this, 'hubOptions.hubDid') }
            ...
            { showAdvanced &&
              <div class='form-group'>
                ...
                <input type='text' class='form-control' value={ hubOptions.hubEndpoint } onChange={ linkState.linkState(this, 'hubOptions.hubEndpoint') }
                  placeholder='(will be resolved automatically)'/>
              </div>
            }
